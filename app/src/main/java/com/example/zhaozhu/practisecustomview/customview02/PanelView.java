...
public class PanelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //最外面线条
        secondRectF.set(strokeWidth, strokeWidth, mWidth - strokeWidth, mHeight - strokeWidth);
        canvas.drawArc(secondRectF, 145, 250, false, p);

        //绘制粗线
        p.setStrokeWidth(mSecondArcWidth);
        secondRectF.set(strokeWidth + 50, strokeWidth + 50, mWidth - strokeWidth - 50, mHeight - strokeWidth - 50);
...
//        Log.e("wing", fill + "");
        ...
        canvas.drawLine(mWidth / 2, (mHeight / 2 - secondRectHeight / 2) + mSecondArcWidth / 2 + 2, mWidth / 2, mHeight / 2 - mMinCircleRadius, p);
